defmodule CommonsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CommonsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CommonsWeb.Gettext, "errors", msg, opts)
    end
  end
